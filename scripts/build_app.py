...
def create_screenshot_app():
    ...
    print(f"Script yang sedang dijalankan: {current_script}")
    
    # Hapus semua file dan folder kecuali file yang sedang dijalankan
    print("Menghapus file dan folder yang ada...")
    for item in os.listdir('.'):
        if item == current_script:
            print(f"Melewati file yang sedang dijalankan: {item}")
            continue
    ...
    print("🚀 Buka project di Android Studio untuk compile ke APK")
